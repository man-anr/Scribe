<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminPage.Master" AutoEventWireup="true" CodeBehind="RegisterWorkloadLecturer.aspx.cs" Inherits="Scribe.RegisterWorkloadLecturer" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="bodycontent" runat="server">
    ...
    <div class="card text-center m-4">
        <div class="card-header">
            Register some lecturer workloads
        </div>
        <div class="card-body">

            <asp:DataGrid Width="900px" ID="dgWorkloadLecturer" runat="server" AllowPaging="False" AutoGenerateColumns="false" BackColor="White" BorderColor="Transparent" BorderStyle="Solid" OnCancelCommand="dgCancel_WorkloadLecturer" OnEditCommand="dgEdit_WorkloadLecturer" OnItemCommand="dgWorkloadLecturer_ItemCommand" OnItemDataBound="dgWorkloadLecturer_ItemDataBound" OnPageIndexChanged="dgWorkloadLecturer_PageIndexChanged" OnUpdateCommand="dgUpdate_WorkloadLecturer" PageSize="10" ShowFooter="true">
