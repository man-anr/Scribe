<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminPage.Master" AutoEventWireup="true" CodeBehind="RegisterLecturer.aspx.cs" Inherits="Scribe.RegisterLecturer" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="bodycontent" runat="server">
    <div class="card text-center m-4">
        ...
        <div class="card-body">
            ...
            <asp:DataGrid Width="900px" ID="dgLecturer" runat="server" AllowPaging="False" AutoGenerateColumns="false" BackColor="White" BorderColor="Transparent" BorderStyle="Solid" OnCancelCommand="dgCancel_Lecturer" OnEditCommand="dgEdit_Lecturer" OnItemCommand="dgLecturer_ItemCommand" OnItemDataBound="dgLecturer_ItemDataBound" OnPageIndexChanged="dgLecturer_PageIndexChanged" OnUpdateCommand="dgUpdate_Lecturer" PageSize="10" ShowFooter="true">
